...
## 进入服务器
    ...
    <div style={{ background: 'rgb(253,228,232)' ,padding: '15px', margin: '10px 0' ,borderRadius: 'var(--ifm-code-border-radius)'}}>
      <text style={{fontSize: '15px' , color: 'rgb(39, 39, 39)'}}><b>⚠️这并不能代替正版</b><br/>
      第三方登录不属于正版，旨在为离线玩家提供更好的体验，保护玩家的物品信息，防止被恶意盗用。  <br/></text>
    </div>

<Tabs>
  <TabItem  value="第三方登录" label="1.为什么使用第三方登录？" default>
    <div >
      ## 为什么使用第三方登录？
  ...
  <TabItem value="下载Java21" label="2.为什么要下载安装Java？">
    ## 为什么要下载安装Java？
  ...
  <TabItem value="客户端配置" label="3.怎么在PCL2中配置第三方登录？">
   ##  怎么在PCL2中配置第三方登录？
